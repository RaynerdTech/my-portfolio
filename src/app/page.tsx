...
export const metadata: Metadata = {
  ...
  description:
    "I build high-performance, SEO-optimized websites for Nigerian & international businesses using Next.js, React, Node.js and TailwindCSS. Let's grow your brand online.",
