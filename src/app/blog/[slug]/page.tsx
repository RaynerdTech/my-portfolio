...
// --- UI Components ---
const PostHeader = ({ title, date, author, readingTime }: { title: string; date: string; author: any; readingTime: number }) => (
    ...
    <article className="max-w-3xl mx-auto px-4 sm:px-6 py-12 lg:py-16 mt-12">
      ...
      <div
        className="
          ...
          max-w-none
          dark:prose-invert
          prose-headings:font-serif prose-headings:tracking-normal
          prose-h1:text-4xl sm:prose-h1:text-5xl prose-h1:font-bold prose-h1:leading-tight 
          prose-h1:mb-8 prose-h1:mt-16 prose-h1:text-gray-900 dark:prose-h1:text-white
          prose-h1:border-b prose-h1:pb-4 prose-h1:border-gray-200 dark:prose-h1:border-gray-700
          prose-h2:text-3xl sm:prose-h2:text-4xl prose-h2:font-semibold prose-h2:mt-12 prose-h2:mb-6
          prose-h2:text-gray-800 dark:prose-h2:text-gray-200
          prose-h3:text-2xl sm:prose-h3:text-3xl prose-h3:font-medium prose-h3:mt-10 prose-h3:mb-5
          prose-h4:text-xl sm:prose-h4:text-2xl prose-h4:font-medium prose-h4:mt-8 prose-h4:mb-4
          ...
          prose-a:underline-offset-4 prose-a:transition-all prose-a:hover:text-blue-800 dark:prose-a:hover:text-blue-300
          prose-a:hover:underline prose-a:decoration-2
          ...
          prose-blockquote:px-8 prose-blockquote:py-6 prose-blockquote:rounded-r-xl
          ...
          prose-li:my-3 prose-li:pl-2 prose-li:marker:text-blue-500 dark:prose-li:marker:text-blue-400
          prose-img:rounded-2xl prose-img:shadow-xl prose-img:mx-auto prose-img:border prose-img:border-gray-200 dark:prose-img:border-gray-700
          prose-figure:my-10
          prose-figcaption:text-center prose-figcaption:italic prose-figcaption:text-gray-500 dark:prose-figcaption:text-gray-400
          prose-figcaption:mt-3 prose-figcaption:text-sm
          ...
          prose-th:bg-gray-100 dark:prose-th:bg-gray-800 prose-th:px-6 prose-th:py-3 
          prose-th:text-left prose-th:font-semibold prose-th:text-gray-900 dark:prose-th:text-gray-200
          prose-td:border-t prose-td:px-6 prose-td:py-4 prose-td:border-gray-200 dark:prose-td:border-gray-700
          prose-hr:border-gray-200 dark:prose-hr:border-gray-700 prose-hr:my-12 prose-hr:border-t-2
        "
      >
        <div
          className="
            ...
            [&>table]:my-10
            [&>hr]:my-14
            [&>ul>li]:pl-3 [&>ol>li]:pl-3
            [&>ul>li>p]:my-2 [&>ol>li>p]:my-2
          "
