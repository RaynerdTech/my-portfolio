...
// // Remove the Props interface, or modify it to exclude `extends PageProps`
// // interface Props {
// //   params: { slug: string };
...
//     // ✅ Wrap slug inside a `params` object
...
// // Modify the function signature to directly destructure params and searchParams
// export default async function BlogPostPage({ params }: { params: { slug: string } }) {
//   const { slug } = params; // ✅ Now safe, because we're inside an async fn
