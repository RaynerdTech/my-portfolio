...
export const metadata: Metadata = {
  ...
  description:
    "Explore the web and WordPress development services offered by Ray. From starter websites to complex, scalable applications, I build digital solutions in Lagos, Nigeria to help your business grow.",

  // Keywords: Relevant terms potential clients might search for.
  keywords: [
    "web development nigeria",
    "wordpress developer lagos",
    "next.js developer",
  ...
  openGraph: {
    ...
    description:
      "Ready to bring your project to life? I offer professional Web/Code and WordPress development services, tailored to fit your needs, from right here in Lagos.",
