...
export const metadata: Metadata = {
  ...
  description: 'Learn more about Ray, a passionate full-stack developer from Lagos, Nigeria. Discover my journey, my skills in Next.js and React, and my mission to help businesses succeed online.',
  ...
  openGraph: {
    ...
    images: ['https://portfolio.raynerd.com.ng/images/raynerd-tech.jpg'], 
