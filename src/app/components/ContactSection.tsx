...
// You might want to define your social links and contact info here or in a separate config file
const SOCIAL_LINKS = [
  { name: 'LinkedIn', icon: 'linkedin', url: 'https://www.linkedin.com/in/yourprofile' },
  { name: 'GitHub', icon: 'github', url: 'https://github.com/yourusername' },
  { name: 'X (Twitter)', icon: 'twitter', url: 'https://x.com/yourhandle' },
  { name: 'Instagram', icon: 'instagram', url: 'https://instagram.com/yourprofile' },
];

const CONTACT_INFO = [
  { type: 'Email', value: 'your.email@example.com', icon: 'mail' },
  { type: 'Phone', value: '+234 801 234 5678', icon: 'phone' }, // Example Nigerian number
...
export const ContactSection = () => {
  ...
  // Helper for icons (you'll replace these with actual SVG components or an icon library)
  const getIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'mail': return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.728v14.441h24v-14.441l-12 9.728z"/></svg>;
      ...
      case 'location': return <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0c-4.198 0-8 3.403-8 7.602 0 4.198 3.802 8.397 8 16.398 4.198-8.001 8-12.2 8-16.398 0-4.199-3.802-7.602-8-7.602zm0 11c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3z"/></svg>;
      default: return null;
    }
  };
  ...
  return (
    <section id="contact" className="relative z-10 py-16 px-4 sm:py-24 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
      {/* Dynamic Background Elements - unchanged */}
      ...
      <div className="relative p-2 rounded-4xl bg-gradient-to-br from-slate-800/60 to-slate-900/60 shadow-inner-xl border border-slate-700/50">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-0 items-stretch justify-center rounded-3xl overflow-hidden">
          ...
          >
            ...
            {submitMessage && (
              <motion.p
                className={`mt-3 sm:mt-4 text-center text-base sm:text-xl font-semibold ${submitMessage.includes('Oops') ? 'text-red-400' : 'text-green-400'}`}
